...
def test_personnel_cannot_access_welfare_alerts(client):
...
def test_commander_cannot_access_welfare_alerts(client):
...
def test_admin_cannot_access_clinical_telemetry(client):
...
def test_welfare_officer_can_access_assigned_cohort(client):
